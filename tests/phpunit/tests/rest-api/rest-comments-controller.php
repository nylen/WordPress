...
class WP_Test_REST_Comments_Controller extends WP_Test_REST_Controller_Testcase {
	...
	public function test_comment_roundtrip_as_editor_1() {
	...
	public function test_comment_roundtrip_as_editor_2() {
		wp_set_current_user( self::$editor_id );
		if ( is_multisite() ) {
	...
	public function test_comment_roundtrip_as_editor_unfiltered_html_1() {
		wp_set_current_user( self::$editor_id );
		if ( is_multisite() ) {
			$this->assertFalse( current_user_can( 'unfiltered_html' ) );
			$this->verify_comment_roundtrip( array(
	...
	public function test_comment_roundtrip_as_editor_unfiltered_html_2() {
		wp_set_current_user( self::$editor_id );
		if ( is_multisite() ) {
			$this->assertFalse( current_user_can( 'unfiltered_html' ) );
			$this->verify_comment_roundtrip( array(
				'content'           => '<a href="#" target="_blank" data-unfiltered=true>link</a>',
				'author_name'       => '<a href="#" target="_blank" data-unfiltered=true>link</a>',
				'author_user_agent' => '<a href="#" target="_blank" data-unfiltered=true>link</a>',
			), array(
				'content' => array(
					'raw'      => '<a href="#" rel="nofollow">link</a>',
					'rendered' => '<p><a href="#" rel="nofollow">link</a></p>',
				),
				'author_name'       => 'link',
				'author_user_agent' => 'link',
			) );
		} else {
			$this->assertTrue( current_user_can( 'unfiltered_html' ) );
			$this->verify_comment_roundtrip( array(
				...
				'content' => array(
					'raw'      => '<a href="#" target="_blank" data-unfiltered=true rel="nofollow">link</a>',
					'rendered' => '<p><a href="#" target="_blank" data-unfiltered=true rel="nofollow">link</a></p>',
				),
				'author_name'       => 'link',
				'author_user_agent' => 'link',
			) );
	...
	public function test_comment_roundtrip_as_superadmin_1() {
	...
	public function test_comment_roundtrip_as_superadmin_2() {
		wp_set_current_user( self::$superadmin_id );
		$this->assertTrue( current_user_can( 'unfiltered_html' ) );
		$this->verify_comment_roundtrip( array(
			'content'           => '\\\&\\\ &amp; &invalid; < &lt; &amp;lt;',
	...
	public function test_comment_roundtrip_as_superadmin_unfiltered_html_1() {
		wp_set_current_user( self::$superadmin_id );
		$this->assertTrue( current_user_can( 'unfiltered_html' ) );
		$this->verify_comment_roundtrip( array(
			'content'           => '<div>div</div> <strong>strong</strong> <script>oh noes</script>',
	...
	public function test_comment_roundtrip_as_superadmin_unfiltered_html_2() {
		wp_set_current_user( self::$superadmin_id );
		$this->assertTrue( current_user_can( 'unfiltered_html' ) );
		$this->verify_comment_roundtrip( array(
			'content'           => '<a href="#" target="_blank" data-unfiltered=true>link</a>',
